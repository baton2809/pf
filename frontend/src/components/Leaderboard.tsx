...
export const Leaderboard: React.FC = () => {
  ...
  const currentUserRank = 0; // Mock data removed - use real API data only
  ...
  return (
    <div className="leaderboard-container">
      <div className="page-header">
        <h3 style={{ marginBottom: '20px', marginLeft: '40px', fontSize: '1.5rem' }}>Соревнуйтесь с коллегами и отслеживайте свой прогресс</h3>
      </div>
        ...
        <div className="current-user-info">
          <div className="user-details">
            ...
            <div className="rank-display">
              <span className="rank-number">{getRankIcon(currentUserRank)}</span>
              <span className="rank-text">из {allUsers.length} участников</span>
            </div>
          </div>
        </div>
